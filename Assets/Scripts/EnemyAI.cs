...
public class EnemyAI : MonoBehaviour
{
    ...
    // 적 탐지 통지 관련
    static public event Action OnFindEnemy;
    ...
    IEnumerator CoroutineWalk()
    {
        ...
        // 목적지 설정
        targetPos = transform.position + new Vector3(UnityEngine.Random.Range(-7f, 7f), 0f, UnityEngine.Random.Range(-7f, 7f));
